      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
              onClick={() => router.back()}
              className="p-2 rounded-lg transition" style={{ background: "oklch(14% 0 0)", border: `1px solid ${BORDER}` }}>
        ...
        {loading ? (
          ...
          <div className="text-center py-24">
            ...
            <Link href="/chat" className="inline-block px-6 py-3 rounded-lg font-semibold text-white transition"
              style={{ background: A }}>
              Start Chatting
            </Link>
          </div>
